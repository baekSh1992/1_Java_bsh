...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		// -> boolean의 리터럴(값) 표기법은 true / false 만 사용 
		...
		longNum = 10000000000L; // < 뒤에 l을 붙혀야 함 
		// 10000000000은 int 표기법이므로 int의 최대 크기를 넘어 설 수 없다.
		// -> long 자료형의 리터럴 표기법은 정수 뒤에 L 또는 l 작성. ( float도 마찬가지 뒤에f )
		...
		ch2 = 66; // 'B'
		// char 자료형은 숫자-문자로 연결된 문자표에서
		// 일치하는 문자나 숫자의 문자부분만 출력
		
		// syso + 컨 + 스페이스 = println() 자동완성
