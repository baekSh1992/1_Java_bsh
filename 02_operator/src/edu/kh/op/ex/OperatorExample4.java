...
public class OperatorExample4 {
		public static void main(String[] args) {
			...
			boolean result3 = 1 <= b;  // b는 1 이상인가? t
			
			boolean result4 = b <= 10; // b는 10 이하인가? t
			
			
			System.out.println("b는 1부터 10사이의 정수인가? " + (result3 && result4)); // t
			...
			boolean result7 = e < 1 || e >= 5; // e는 1 미만 또는 5 이상인가? 
