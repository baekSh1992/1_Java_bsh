...
public class WhileExample {
	...
	public void ex3() {
		...
		String menu = "";
		// "" == 빈 문자열 ( 내용은 없지만 문자열임. string 리터럴 표기법 )
		...
		while(input != 9) {
			...
			if(flag && (input >= 1 && input <= 4) ) { // true인 경우 실행(첫 주문 X) + 메뉴를 잘 입력 했을 때
				menu += ", ";
			
			} else { // false인 경우 실행(첫 주문)
				flag = true;
