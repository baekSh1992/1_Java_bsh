...
public class MethodExampleView {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("--------------------------");
			System.out.println("1. 매개변수 X, 리턴(반환) 값 X 경우");
			System.out.println("2. 매개변수 O, 리턴(반환) 값 X 경우");
			System.out.println("3. 매개변수 X, 리턴(반환) 값 O 경우");
			System.out.println("4. 매개변수 O, 리턴(반환) 값 O 경우");
