...
public class Example1 {
	...
	public void ex1() {
		...
		// c2.setWeight(1.5); // 에러
		// The method setWeight(double) is undefined(정의되지 않았다) for the type Car
	...
	public void ex2() {
		...
		arr[1] = new Truck(8, 3, "경유", 5.0); // Truck 객체 ( 업 캐스팅 적용 ) 
		// Car 참조 변수 
		
		arr[2] = new Spark(4, 4, "휘발유", 0.5); // Spark 객체 ( 업캐스팅 적용 ) 
		// Car 참조 변수
...
// 추상메서드(abstract method) : 코드가 없는 메서드 public >> abstract << 가 들어가야 추상메서드 void a();
// 추상클래스 : 추상메서드를 포함한 클래스
	
//	a b c 자식들이 공통적인 기능이 있다
//	코드길이 길어져서 부모한테 써놓고 상속받는다
//	자식1은 100
//	자식2는 200
//	자식3은 300 나와야한다
//	a라는 물려받을건 하나인데 왜 다 다르냐
//	차별 상속X 공평 상속 해야한다.
//	
//	-> 부모가 이름만있는 메서드를 만들고 물려준다
