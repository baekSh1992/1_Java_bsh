...
import edu.kh.poly.ex1.model.vo.BSHCalculator;
import edu.kh.poly.ex1.model.vo.Calculator;
...
public class AbstractionService {
	...
	//  f1.breath();
		...
		// -> 동적 바인딩에 의해 정상 수행될 것을 알기 때문에 에러가 안난다.
		...
		// arr[i]번째 인덱스에 어떤 Animal자식 객체가 있는지 모르지만
	...
	public void ex2() {
		...
		// 인터페이스 미완성 메서드로만 이루어져 있어서 직접 객체 생성 불가
	...
	public void ex3() {
		...
		Calculator cal = new BSHCalculator();
