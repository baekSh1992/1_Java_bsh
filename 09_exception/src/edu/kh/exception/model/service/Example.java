...
public class Example {
	...
	public void ex1() {
		...
		//	  호출 시 반드시 예외처리를 하시오.
		// "반드시" 라는 구문에서 알 수 있듯 Checked Exception 이다.
...
//			System.out.println("0으로 나눌수 없습니다.");
	...
	public void ex4() {
		...
		try {
			...
			e.printStackTrace();
			// e : 예외 객체 참조 변수
			// StackTrace : 예외가 발생한 메서드를 따라가다 (*Trace : 따라가다)
		}
