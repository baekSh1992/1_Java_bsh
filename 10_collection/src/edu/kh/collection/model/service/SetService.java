...
public class SetService {
	...
	public void ex2() {
		...
		set.add(new Student("김말동", 16, "서울시 동작구", 'F', 60));
		set.add(new Student("홍길동", 15, "서울시 중구", 'M', 50));

		Student s1 = (new Student("김길순", 15, "서울시 중구", 'M', 50));
		Student s2 = (new Student("김길순", 15, "서울시 중구", 'M', 40));
