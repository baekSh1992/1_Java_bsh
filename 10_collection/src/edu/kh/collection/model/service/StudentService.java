...
public class StudentService {
	...
	private List<Student> stdList = new ArrayList<Student>();
							// Student 타입으로 제한 된 ArrayList객체 생성
	
	
	public StudentService() {
		stdList.add( new Student("홍길동", 18, "서울시 강남구", 'M', 80));
		stdList.add( new Student("김종국", 42, "서울시 서초구", 'F', 60));
		stdList.add( new Student("권은구", 34, "서울시 성동구", 'M', 90));
	}
...
//		stdList.add(std);
		...
		List<String> test2 = new ArrayList<String>(); // < 사용안하는 코드 테스트용
		...
		// test3.add(Integer e)-> 타입 제한 O, 모든 참조 변수가 Integer타입
